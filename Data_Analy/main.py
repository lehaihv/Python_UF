...
print("Shape of citibike data: {}".format(covid_level.shape))  # show shape of dataset including number of data points
# and features
...
print(covid_level[covid_level["health_service_area_population"].isnull()].head())  # Print first 5 row (head) with
# nulls of dataset
# print(covid_level[covid_level["county_population"].isnull()].tail())  # Print last 5 row (tail) with nulls of dataset
